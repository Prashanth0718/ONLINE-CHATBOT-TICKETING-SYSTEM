      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a href="mailto:support@museumgo.com" className="bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-blue-50 transition-colors duration-300">
              Email Support
            </a>
            <a href="tel:+15551234567" className="text-white border-2 border-white px-6 py-3 rounded-xl font-semibold hover:bg-white/10 transition-colors duration-300">
              Call Us
            </a>
          </div>
        </motion.div>
